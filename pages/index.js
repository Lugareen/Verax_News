...
function CookieBanner() {
  ...
  return (
    <div style={{ position:"fixed", bottom:0, left:0, right:0, zIndex:9999, background:"#0D1B3E", borderTop:"2px solid #C9933A", padding:"16px 32px", display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:12 }}>
      <p style={{ fontSize:13, color:"rgba(255,255,255,0.8)", margin:0, maxWidth:700, lineHeight:1.6 }}>
        🍪 Diese Website verwendet technisch notwendige Cookies für die Login-Funktion. Durch die weitere Nutzung stimmen Sie der Verwendung zu.{" "}
        <a href="/datenschutz" style={{ color:"#C9933A", textDecoration:"underline" }}>Datenschutzerklärung</a>
      </p>
