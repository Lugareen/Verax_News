      ...
      <div style={{ minHeight:"100vh", background:"#FAFAF7", fontFamily:"'DM Sans', sans-serif" }}>
        ...
        <div style={{ maxWidth:800, margin:"0 auto", padding:"100px 32px 80px" }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:32, fontSize:15, color:"#1A1A2A", lineHeight:1.8 }}>
            ...
            <section>
              <h2 style={{ fontFamily:"'Syne', sans-serif", fontSize:20, fontWeight:700, color:"#0D1B3E", marginBottom:12 }}>5. Widerspruch gegen Werbe-E-Mails</h2>
            ...
            <section>
              <h2 style={{ fontFamily:"'Syne', sans-serif", fontSize:20, fontWeight:700, color:"#0D1B3E", marginBottom:12 }}>6. SSL-Verschlüsselung</h2>
            ...
            <section>
              <h2 style={{ fontFamily:"'Syne', sans-serif", fontSize:20, fontWeight:700, color:"#0D1B3E", marginBottom:12 }}>7. Ihre Rechte</h2>
