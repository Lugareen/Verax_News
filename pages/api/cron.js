...
Aus den Suchergebnissen: Identifiziere Artikel von diesen Medien:
Deutsch: Spiegel, taz, Süddeutsche Zeitung, Zeit, Tagesspiegel, Stern, Frankfurter Rundschau, nd, RND
International: Guardian, New York Times, NPR, Washington Post, Le Monde, Der Standard, BBC

Falls keine dieser Medien direkt gefunden wird: Suche nach ähnlichen progressiven/linken Quellen in den Ergebnissen.
IGNORIERE: Parteiseiten, Blogs, RT, unbekannte Seiten, Boulevardmedien.

Gib NUR valides JSON zurück:
{"articles":[{"source":"Spiegel","title":"Artikeltitel","key_points":["Kernaussage 1","Kernaussage 2"]}],"search_successful":true}`,
    messages: [{
      role: "user",
      content: `Thema: ${topic.topic}\nDatum: ${today}\n\nFühre die Suchen durch und extrahiere Artikel von links-liberalen Medien.`
    }]
  }));
...
Aus den Suchergebnissen: Identifiziere Artikel von diesen Medien:
Deutsch: FAZ, Frankfurter Allgemeine, Welt, NZZ, Focus, Cicero, Handelsblatt, Wirtschaftswoche, Capital
International: Wall Street Journal, WSJ, Telegraph, Washington Examiner, The Times, The Spectator, NZZ

Falls keine dieser Medien direkt gefunden wird: Suche nach ähnlichen konservativen/wirtschaftsliberalen Quellen.
IGNORIERE: Breitbart, RT, Blogs, Parteiseiten.
...
{"articles":[{"source":"FAZ","title":"Artikeltitel","key_points":["Kernaussage 1","Kernaussage 2"]}],"search_successful":true}`,
    messages: [{
      role: "user",
      content: `Thema: ${topic.topic}\nDatum: ${today}\n\nFühre die Suchen durch und extrahiere Artikel von konservativen Medien.`
    }]
  }));
