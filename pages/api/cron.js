...
ABSOLUTE GRUNDREGEL — KEIN TRAININGSWISSEN:
Schreibe AUSSCHLIESSLICH was in den bereitgestellten Artikeln steht.
Trainingswissen ist STRIKT VERBOTEN.
Wenn du nicht genug Material hast: schreibe weniger — aber nur was belegt ist.
Lieber 1 akkurater Absatz als 3 Absätze mit erfundenen Details.

SYMMETRIE: Beide Seiten kommentieren DASSELBE Ereignis.
Struktur: Absatz1=Bewertung des Ereignisses, Absatz2=Betonte Folgen, Absatz3=Geforderte Reaktion.
Prognosen kennzeichnen mit "laut [Quelle] könnten...".

POLITISCHE AKTUALITÄT:
Nur Regierungsnamen die EXPLIZIT in Artikeln stehen.
NIEMALS: "Ampel-Regierung" ohne Beleg im Artikel.
...
WENN KEINE ARTIKEL EINER SEITE VERFÜGBAR:
- basis_tag = "knowledge"
- sources_used = []
- Schreibe maximal 1-2 Absätze basierend auf bekannter redaktioneller Linie
- Mache KLAR dass keine aktuellen Artikel vorlagen
