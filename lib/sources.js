...
export const CATEGORIES = [
  ...
  },
  {
    ...
    sub: "Deutschland",
    icon: "🇩🇪",
    keywords: ["Deutschland", "Bundesregierung", "Bundestag", "Berlin", "SPD", "CDU", "Grüne", "FDP", "AfD", "Scholz", "Merz", "Wirtschaft", "Bundesbank", "Konjunktur", "Bundeshaushalt"],
    accentColor: "#C9933A",
    bgColor: "#FFF4E6",
  },
  {
  ...
  },
  {
    ...
    sub: "Deutschland",
    icon: "🏦",
    keywords: ["DAX", "MDAX", "Frankfurt", "Deutsche Bank", "SAP", "Siemens", "Volkswagen", "BMW", "Allianz", "Bayer", "Börse Frankfurt", "SDAX", "TecDAX"],
    accentColor: "#2E7D32",
    bgColor: "#E8F5E9",
  },
];
