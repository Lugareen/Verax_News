...
export const SECONDARY_SOURCES = [
  ...
  // === INTERNATIONALE KONSERVATIVE QUELLEN (neu) ===
  { name: "Wall Street Journal",    url: "https://feeds.a.dj.com/rss/RSSWorldNews.xml",                          lean: "right",   type: "newspaper", country: "int" },
  { name: "New York Post",          url: "https://nypost.com/feed/",                                             lean: "right",   type: "newspaper", country: "int" },
  { name: "Fox News",               url: "https://feeds.foxnews.com/foxnews/world",                              lean: "right",   type: "tv",        country: "int" },
  { name: "The Spectator",          url: "https://www.spectator.co.uk/feed/",                                    lean: "right",   type: "magazine",  country: "int" },

  // === INTERNATIONALE LINKE QUELLEN (neu) ===
  { name: "The Independent",        url: "https://www.independent.co.uk/news/rss",                               lean: "left",    type: "newspaper", country: "int" },
  { name: "Der Standard",           url: "https://derstandard.at/rss",                                          lean: "left",    type: "newspaper", country: "int" },
